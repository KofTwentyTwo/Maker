...
import avatar           from "makers4/assets/img/user.png";
import AdminNavbarLinks from "makers4/components/Navbars/AdminNavbarLinks.js";
...
class SidebarWrapper extends React.Component
{
   ...
   render()
   {
      ...
      return (
            <div className={className} ref={this.sidebarWrapper}>{user}{headerLinks}{links}</div>
      );
   }
}
            ...
            <div className={userWrapperClass}>
               ...
               <List className={classes.list}>
                  ...
                  <ListItem className={classes.item + " " + classes.userItem}>
                     ...
                     {/*/////////////////////////////////////*/}
                     {/*// Links within the Avatar Section // */}
                     {/*/////////////////////////////////////*/}
                     <Collapse in={this.state.openAvatar} unmountOnExit>
                        <List className={classes.list + " " + classes.collapseList}>

                           <ListItem className={classes.collapseItem}>
                              <NavLink to="/admin/view-profile" className={classes.itemLink + " " + classes.userCollapseLinks}>
                           ...
                           <ListItem className={classes.collapseItem}>
                              <NavLink to="/admin/view-settings" className={classes.itemLink + " " + classes.userCollapseLinks}>
